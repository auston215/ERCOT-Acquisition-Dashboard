    ...
    if lat_col is None or lon_col is None:
        ...
        if mapped_universe.empty:
            ...
            if filtered_map.empty:
                ...
                # =================================================
                technology_colors = {
                    "Solar": [245, 166, 35, 215],
                    "Storage": [38, 132, 255, 215],
                    "Wind": [47, 158, 68, 215],
                }

                map_plot["Map Color"] = map_plot[
                    "Power Project Type"
                ].apply(
                    lambda tech: technology_colors.get(
                        clean_text(tech),
                        [120, 120, 120, 200]
                    )
                )
                ...
                # Keep all filtered points visible and add a dark ring
                # around the selected project.
                # =================================================
